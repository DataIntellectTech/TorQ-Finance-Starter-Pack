...
start "kill" q torq.q -proctype kill -procname killtick -load code/processes/kill.q -.servers.CONNECTIONS rdb wdb tickerplant chainedtp hdb gateway housekeeping monitor discovery sort sortslave reporter compression feed metrics
