...
packets:([] time:`timestamp$(); sym:`symbol$(); src:`symbol$(); dest:`symbol$(); srcport:`long$(); destport:`long$(); protocol:`symbol$(); flags:(); seq:`long$(); ack:`long$(); win:`long$(); tsval:`long$(); tsecr:`long$(); length:`long$(); len:`long$(); data:())
