...
nohup q ${TORQHOME}/torq.q -load ${TORWHOME}/code/processes/housekeeping.q ${KDBSTACKID} -proctype housekeeping -procname housekeeping1 -U ${KDBAPPCONFIG}/passwords/accesslist.txt -localtime </dev/null >$KDBLOG/torqhousekeeping.txt 2>&1 &
...
# launch vtwap
echo 'Starting vtwap...'
nohup q ${TORQHOME}/torq.q -load ${KDBTORQFSP}/code/processes/vtwap.q ${KDBSTACKID} -proctype wap -procname wap1 -U ${KDBAPPCONFIG}/passwords/accesslist.txt -localtime -g 1 </dev/null >$KDBLOG/torqwap.txt 2>&1 &
